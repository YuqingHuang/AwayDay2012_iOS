//
//  PostShareViewController_public.h
//  AwayDay2012
//
...
@interface PostShareViewController_public : UIViewController <UIActionSheetDelegate, UITextViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
